const config = [
  ...
  },
  {
    title: "道路交通图例",
    content: [
      { imgSrc: require("../../assets/img/lenged-daolujiaotong.png"), font: "道路连接点" },
    ],
  },
  {
    title: "轨道交通图例",
    content: [
      { imgSrc: require("../../assets/img/lenged-guidaojiaotong.png"), font: "轨道枢纽站点" },
    ],
  },
  {
    title: "城市交通图例",
    content: [
      { imgSrc: require("../../assets/img/lenged-chengshijiaotong.png"), font: "邻近城市" },
    ],
  },
  {
    title: "基础设施图例",
    content: [
      ...
      { imgSrc: require("../../assets/img/lenged-yiliao.png"), font: "医疗设施" },
      { imgSrc: require("../../assets/img/lenged-jiaoyu.png"), font: "教育设施" },
      { imgSrc: require("../../assets/img/lenged-wenti.png"), font: "文体设施" },
      { imgSrc: require("../../assets/img/lenged-shizheng.png"), font: "市政设施" },
    ],
  },
  {
    title: "景观设施图例",
  ...
  },
  {
    title: "产业设施图例",
    content: [
      { imgSrc: require("../../assets/img/lenged-1stindustry.png"), font: "第一产业" },
      { imgSrc: require("../../assets/img/lenged-2rdindustry.png"), font: "第二产业" },
      { imgSrc: require("../../assets/img/lengend-3rdindustry.png"), font: "第三产业" },
    ],
  },
  {
    title: "地籍概况图例",
