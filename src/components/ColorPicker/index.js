...
export default class ColorPicker extends Component {
  ...
  componentDidMount () {
    ...
    if (colorStr) {
      ...
      const colorObj = { r: colorArr[0] || 255, g: colorArr[1] || 255, b: colorArr[2] || 255, a: colorArr[3] || 1 }
  ...
  render () {
    let disable = "",backgroundColor = this.state.colorStyle;
    ...
    const overlay = (
      <div className={panelStyles.wrap}
        ...
        <SketchPicker className={panelStyles.sketch}
    ...
    return (
      <Dropdown overlay={overlay}
        ...
        <div className={btnStyles.wrap + disable}
