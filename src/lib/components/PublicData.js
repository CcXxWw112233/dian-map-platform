import { addFeature, Source, Layer ,loadFeatureJSON ,getExtent ,getPoint ,createStyle} from '../../lib/utils'
        ...
        if(data){
            if(data.features.length){
                data.features.forEach(item => {
                    ...
                    let feature = addFeature(type,{coordinates: coor, ...item.properties});
                    if(option.style){
