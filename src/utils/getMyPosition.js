...
export const getMyPosition = {
  ...
  clear: function () {
    if (
      this.source &&
      this.source.getFeatureByUid(
        this.positionCircle && this.positionCircle.ol_uid
      )
    ) {
    ...
    if (
      this.source &&
      this.source.getFeatureByUid(this.positionIcon && this.positionIcon.ol_uid)
    ) {
  ...
  setPosition: function () {
    ...
    this.positionIcon &&
      this.positionIcon.getGeometry().setCoordinates(coordinate);
    this.positionCircle &&
      this.positionCircle.getGeometry().setCenter(coordinate);
